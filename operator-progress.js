...
(() => {
  ...
  const stageOrder=['new','experienced_not_target','interview_booked','interviewed','questionnaire','test_1_completed','productivity_invited','productivity_booked','productivity_passed','productivity_failed','test_1_passed','finalist','selection_closed','rejected','cancelled','academy_contact','training','internship','hired'];
