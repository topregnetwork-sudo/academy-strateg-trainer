...
Preserve personal messages, primary-topic2, other chats/topics, payload text/buttons, candidate states, slots, timers. Edit/delete of historical messages is never rerouted; no historical copy or deletion.
Rollback code only: revert045 commits together; new messages already delivered to619 remain there. No candidate/data rollback required.
